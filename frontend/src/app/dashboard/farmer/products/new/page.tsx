...
/**
 * Add Product Page
 * Allows farmers to list new products with images and details.
 */
export default function AddProductPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Match the CreateProductDto in the backend
            const payload = {
                name: formData.name,
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8 pb-20">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-black text-zinc-900 dark:text-zinc-100 uppercase tracking-tighter">List New Product</h1>
                    <p className="text-zinc-600 dark:text-zinc-400 font-medium">Create a high-impact listing to attract verified buyers.</p>
                </div>
            </div>
                    ...
                    <Card className="border-0 shadow-2xl">
                        <CardHeader className="border-b bg-zinc-50/30">
                            <CardTitle className="text-lg flex items-center gap-2">
                                <Info className="h-5 w-5 text-green-600" /> Basic Information
                            </CardTitle>
                        </CardHeader>
                ...
                <div className="space-y-6">
                        ...
                        {imagePreview ? (
                            ...
                            <>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-zinc-500 max-w-[150px] mx-auto">Upload high resolution photos of your harvest.</p>
                                </div>
                                <Button variant="outline" type="button" className="border-green-600 text-green-600">Select Files</Button>
                            </>
                        )}
                    </Card>
                    ...
                    <Card className="bg-zinc-900 text-white border-0 shadow-2xl">
                        ...
                        <div className="p-6 border-t border-zinc-800">
                            ...
                            >
                                {loading ? "Publishing..." : <>Publish Listing <Save className="ml-2 h-5 w-5 group-hover:scale-125 transition-transform" /></>}
                            </Button>
                        </div>
                    </Card>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex gap-3">
                                ...
                                <div className="space-y-1">
                                    <p className="text-xs font-bold text-blue-900 uppercase">Farmer Tip</p>
                                    <p className="text-[11px] text-blue-700 leading-relaxed font-medium">Items with detailed descriptions and at least 3 photos sell 40% faster on AgroLink.</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
